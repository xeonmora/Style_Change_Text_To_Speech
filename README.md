# Style_Change_Text_To_Speech
Text to speech with style change for the emotion of the text

### Download the Text to Melspectogram model and put into Text_To_Melspctrogram/weight folder
https://drive.google.com/drive/folders/1U3mcjlQq3JCLTc_3kQTtkszVlGBLCe9G?usp=sharing

### Download the Emtional Style Change model and put into Style_Change/weight folder
https://drive.google.com/file/d/1Nm6p2q-fOl2GQypTEpC4IS6KS8rT0exm/view?usp=sharing

### Download the Melspectogram To Audio model and put into Melspectogram_To_Audio/weight folder
https://drive.google.com/file/d/1iAzIY6XmBtz0WKeDVmbMR4jznMDpTP_K/view?usp=sharing

# Emotional Style changing model is very limited performances - Regarding other researches references
